// pages/newsongs/newsongs_in/newsongs_in.js
Page({
  ...
  playsong:function(events)
  {
    ...
    wx.navigateTo({
      ...
      url: '/pages/playpage/playpage?musicUrl='+encodeURIComponent(m_url)+'&musicName='+m_name+"&musicImg="+m_img+'&author='+m_author+"&musicID="+m_ID,
